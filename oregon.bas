...
80 REM
 ...
 REM X1 = FLAG FOR FORT OPTION155 REM
...
290 PRINT S_I_010
300 PRINT S_I_011
    PRINT : PRINT S_PRESS_KEY : PAUSE 0 : PAUSE 0
    CLS
310 PRINT "YOU WILL NEED TO SPEND THE REST"
    PRINT "OF YOUR MONEY ON THE FOLLOWING"
320 PRINT "ITEMS:"
340 PRINT "OXEN - YOU CAN SPEND $200-$300"
    PRINT "     ON YOUR TEAM, THE MORE YOU"
350 PRINT "     SPEND,THE FASTER YOU'LL GO"
360 PRINT "     BECAUSE YOU'LL HAVE BETTER"
    PRINT "     ANIMALS"
380 PRINT "FOOD - THE MORE YOU HAVE, THE "
    PRINT "     LESS CHANCE THERE IS OF"
390 PRINT "     GETTING SICK"
410 PRINT "AMMUNITION - $1 BUYS A BELT OF"
    PRINT "     50 BULLETS, YOU WILL NEED"
420 PRINT "     BULLETS FOR ATTACKS BY"
    PRINT "     ANIMALS AND BANDITS, AND"
430 PRINT "     FOR HUNTING FOOD"
450 PRINT "CLOTHING - THIS IS ESPECIALLY"
    PRINT "     IMPORTANT FOR THE COLD"
460 PRINT "     WEATHER YOU WILL ENCOUNTER"
    PRINT "     WHEN CROSSING THE"
    PRINT "     MOUNTAINS"
    PRINT : PRINT S_PRESS_KEY : PAUSE 0 
    CLS
490 PRINT "MISCELLANEOUS SUPPLIES - THIS"
    PRINT "     INCLUDES MEDICINE AND"
500 PRINT "     OTHER THINGS YOU WILL NEED"
    PRINT "     FOR SICKNESS AND EMERGENCY"
    PRINT "     REPAIRS"
530 PRINT
540 PRINT "YOU CAN SPEND ALL YOUR MONEY"
    PRINT " BEFORE YOU START YOUR TRIP -"
550 PRINT "OR YOU CAN SAVE SOME OF YOUR"
    PRINT " CASH TO SPEND AT FORTS ALONG"
560 PRINT "THE WAY WHEN YOU RUN LOW. "
    PRINT "HOWEVER, ITEMS COST MORE AT"
570 PRINT "THE FORTS. YOU CAN ALSO GO"
    PRINT " HUNTING ALONG THE WAY TO GET"
580 PRINT "MORE FOOD."
    PRINT
    PRINT : PRINT S_PRESS_KEY : PAUSE 0 
    CLS
590 PRINT "WHENEVER YOU HAVE TO USE YOUR"
    PRINT "TRUSTY RIFLE ALONG THE WAY,"
600 PRINT "YOU WILL BE TOLD TO TYPE IN "
    PRINT "A WORD (ONE THAT SOUNDS LIKE A "
610 PRINT "GUN SHOT). THE FASTER YOU "
    PRINT "TYPE IN THAT WORD AND HIT THE"
620 PRINT """RETURN"" KEY, THE BETTER "
    PRINT "LUCK YOU'LL HAVE WITH YOUR GUN."
630 PRINT
    PRINT : PRINT S_PRESS_KEY : PAUSE 0 
    CLS
640 PRINT "AT EACH TURN, ALL ITEMS ARE "
    PRINT "SHOWN IN DOLLAR AMOUNTS"
650 PRINT "EXCEPT BULLETS"
660 PRINT "WHEN ASKED TO ENTER MONEY "
    PRINT "AMOUNTS, DON'T USE A ""$""."
670 PRINT
680 PRINT "GOOD LUCK!!!"
    PRINT : PRINT S_PRESS_KEY : PAUSE 0
...
730 PRINT "  (4) NEED MORE PRACTICE"
    PRINT "  (5) SHAKY KNEES"
    PRINT 
740 PRINT "ENTER ONE OF THE ABOVE -- THE"
    PRINT "BETTER YOU CLAIM YOU ARE, THE"
750 PRINT "FASTER YOU'LL HAVE TO BE WITH"
    PRINT "YOUR GUN TO BE SUCCESSFUL."
760 Z$=INPUT(1)
    D9 = VAL(Z$)
770 IF D9>5 THEN GOTO 790: end if
780 GOTO 810
    REM FIXME: por que si elijo mas de 5 queda en 0 ¿bug?
790 D9=0
...
1180 PRINT S_AFTER_BUY_1
     ...
     PRINT S_AFTER_BUY_3
     PRINT : PRINT S_PRESS_KEY : PAUSE 0 : PAUSE 0 : CLS
1190 PRINT
...
4700 REM ***MOUNTAINS***
4710 PRINT : PRINT S_PRESS_KEY : PAUSE 0 : PAUSE 0 : CLS
...
5260 Z$=INPUT(3)
     PRINT Z$
5270 IF Z$="YES" THEN GOTO 5310: end if
...
6045 PRINT S_CASH ;T
6050 PRINT : PRINT S_PRESS_KEY : PAUSE 0 : PAUSE 0 : CLS
6060 PRINT S_END_01
     PRINT 
     PRINT S_END_02
     PRINT 
...
6250 PRINT
6255 IF B1>0 THEN GOTO 6260: end if
6257 B1=0
