...
80 REM
 ...
 DIM D1 as uByte : REM = COUNTER IN GENERATING EVENTS
 DIM D3 as uByte : REM = TURN NUMBER FOR SETTING DATE
 REM D4 = CURRENT DATE
 ...
 DIM F9 as Float : REM = FRACTION OF 2 WEEKS TRAVELED ON FINAL TURN
 ...
 DIM M2 as Integer : REM = TOTAL MILEAGE UP THROUGH PREVIOUS TURN
 DIM M9 as uByte : REM = FLAG FOR CLEARING SOUTH PASS IN SETTING MILEAGE
 DIM P as integer : REM = AMOUNT SPENT ON ITEMS AT FORT
 DIM R1 as float : REM = RANDOM NUMBER IN CHOOSING EVENTS
 DIM S4 as uByte : REM = FLAG FOR ILLNESS
 DIM S5 as Integer : REM = ""HOSTILITY OF RIDERS"" FACTOR
 DIM S6 as uByte : REM = SHOOTING WORD SELECTOR
...
2600 IF 100*RND()<13*B1 THEN GOTO 2715: end if
2610 F=F+48-2*B1
2620 PRINT S_HUNT_1
2630 B=B-10-3*B1
2640 GOTO 2715
...
5260 Z$=INPUT(3)
     PRINT Z$
5270 IF (Z$<>"no" AND Z$<>"NO" and z$<>"n" and z$<>"N") THEN GOTO 5310: end if
5280 PRINT S_DIE_06
5290 PRINT
5300 GOTO 5330
5310 PRINT S_DIE_07     
...
6240 B1=(B2-B3) / 50
     ...
     REM PRINT "B3=";B3
     REM PRINT "B2=";B2
     REM PRINT "Seconds=";B1
     REM PRINT "DIFICULT=";D9
     REM B1=B1 - (D9/2) - 0.5
     REM PRINT "Result=";B1
     REM GOSUB 7000
6250 PRINT
...
6257 B1=0
6260 if B1>9 then B1=9: end if
     IF Z$=S$(S6) THEN GOTO 6280: end if
6270 B1=9
6280 RETURN
     REM so B1 = 0 => to slow
